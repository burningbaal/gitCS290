...
<body>
	<?php if(strlen($_POST["username"]) == 0 || empty($_POST["username"])) : ?>
	"A username must be entered. Click <a href="login.php">here</a> to return to the login screen."
	<?php else : ?>
	"Hello <?php echo $_POST["username"]; ?> you have visited this page [n] times before. Click <a href="login.php">here</a> to logout.". <br>
	<?php endif; ?>
</body>
</html>